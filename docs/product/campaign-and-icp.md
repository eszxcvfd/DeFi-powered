...
campaign contract must capture market intent, ICP filters, keyword criteria, and
initial scoring-weight preferences in a way that later discovery, scoring, and
lead workflows can consume without re-entering the same context.
...
- Step 2: industry, product or service focus, and keyword criteria.
- Step 3: ICP criteria.
- Step 4: market region, language, timezone, and date window.
- Step 5: source selection shown as planned or disabled until `US-003`.
- Step 6: scoring weights editable and reviewable.
...
- Unit proof should cover campaign payload validation and ICP field mapping.
