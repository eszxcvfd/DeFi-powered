...
| US-042 | External metrics pipeline baseline (Prometheus exporter, OpenTelemetry collector, Sentry ingestion, Grafana dashboard seam) | yes | yes | no | yes | implemented | `./scripts/verify-us-042.sh`; `docs/ops/metrics-export-runbook.md`; `docs/decisions/0020-external-metrics-pipeline-baseline.md` |
| US-043 | Backup and restore operations baseline (restore workflow, rehearsal, retention, governed data deletion) | yes | yes | no | yes | implemented | `./scripts/verify-us-043.sh`; `docs/ops/backup-restore-runbook.md`; `docs/decisions/0021-backup-and-restore-operations-baseline.md` |
| US-044 | Performance baseline and SLO guardrails (NFR-PERF-001..005, API latency, event list pagination, browser session budget, SLO alert rules) | yes | yes | no | yes | implemented | `./scripts/verify-us-044.sh`; `docs/ops/performance-baseline-runbook.md`; `docs/decisions/0022-performance-baseline-and-slo-guardrails.md` |
| US-045 | Event calendar export (ICS) for watched and selected events (FR-EVT-005, calendar STATUS mapping, tokenized feed, audit entry shape) | yes | yes | yes | yes | implemented | `./scripts/verify-us-045.sh`; `docs/ops/calendar-export-runbook.md`; `docs/decisions/0023-event-calendar-export-ics-baseline.md` |
| US-046 | Connector health surface baseline (FR-ADM-002, per-connector success rate, recent errors, latency, item counts, CAPTCHA rate, last run, closed ConnectorHealthStatus) | yes | yes | yes | yes | implemented | `./scripts/verify-us-046.sh`; `docs/ops/connector-health-runbook.md`; `docs/decisions/0024-connector-health-surface-baseline.md` |
| US-047 | Internationalization and timezone baseline (NFR-I18N-001..003, closed Locale enum vi-VN/en-US, bounded Timezone IANA validation, I18nService, per-user and per-organization locale/timezone surface, audit entries, Unicode normalization) | yes | yes | no | yes | implemented | `scripts/verify-us-047.sh`; `docs/stories/epics/E05-hardening/US-047-internationalization-and-timezone-baseline/`; `docs/product/internationalization-and-timezone.md`; `docs/decisions/0025-internationalization-and-timezone-baseline.md`; `docs/ops/internationalization-runbook.md`; `tests/unit/test_i18n_service.py`; `tests/integration/test_i18n_api.py` |
